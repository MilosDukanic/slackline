...
class BlogControllerTest extends Zend_Test_PHPUnit_ControllerTestCase
{
    ...
    public function testSlackliningAction()
    {
        $params = array('action' => 'slacklining', 'controller' => 'Blog', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    {
        $params = array('action' => 'howto', 'controller' => 'Blog', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
